...
export const RESUME_SUMMARY =
  'Data Analyst skilled in SQL, Python, BigQuery, Hive, Power BI and Tableau. Resolves complex data requests and automates reporting workflows — 250+ tickets handled, manual effort reduced, and credit notes recovered through data-driven audits. Excels at root-cause analysis, campaign and delivery troubleshooting, P&L and decision-making dashboards, and API integrations.';
...
export const RESUME_ROLES: ResumeRole[] = [
  {
    ...
    bullets: [
      ...
      'Resolved 250+ tickets across data pulls, ad-hoc reporting, campaign performance, delivery troubleshooting, margin analysis and audience creation — consistently meeting SLAs.',
  ...
  },
  {
    ...
    bullets: [
      ...
      'Identified discrepancies and secured ₹20–25 lakh in credit notes within four months.',
